...
(function(global, factory) {
    ...
    (function(exports) {
        ...
        var ControlSidebar = function($) {
            ...
            var ControlSidebar = /*#__PURE__*/function() {
                ...
                _proto.toggle = function toggle() {
                        var shouldClose = $('body').hasClass(ClassName.CONTROL_SIDEBAR_OPEN) ||
                ...
                _proto._init = function _init() {
                    ...
                    $(window).scroll(function() {
                        if ($('body').hasClass(ClassName.CONTROL_SIDEBAR_OPEN) ||
                            $('body').hasClass(ClassName.CONTROL_SIDEBAR_SLIDE)) {
                            _this._fixScrollHeight();
                        }
                    });
                        ...
                        if (positions.top === 0 && positions.bottom === 0) {
                            ...
                            if (footerFixed === false) {
                                ...
                                $(Selector.CONTROL_SIDEBAR +
                                    ...
                                    Selector.CONTROL_SIDEBAR +
                                    ' ' +
                                    Selector.CONTROL_SIDEBAR_CONTENT).css('height',
        ...
        var Layout = function($) {
            ...
            var Layout = /*#__PURE__*/function() {
                ...
                _proto.fixLayoutHeight = function fixLayoutHeight(extra) {
                    ...
                    if ($('body').hasClass(ClassName.CONTROL_SIDEBAR_SLIDE_OPEN) ||
                    ...
                    if (offset !== false) {
                        ...
                        if (this._isFooterFixed()) {
                            $(Selector.CONTENT).css('min-height',
                ...
                _proto.remember = function remember() {
                        if (this._options.enableRemember) {
                            ...
                            if (toggleState == ClassName.COLLAPSED) {
                                ...
                                if (this._options.noTransitionAfterReload) {
                                    $("body").addClass('hold-transition').removeClass(ClassName.COLLAPSED).delay(50)
                                        .queue(function() {
                                            $(this).removeClass('hold-transition');
                                            $(this).dequeue();
                                        });
        ...
        var Dropdown = function($) {
            ...
            $(Selector.DROPDOWN_MENU + ' ' + Selector.DROPDOWN_TOGGLE).on("click",
                function(event) {
                    event.preventDefault();
            ...
            $(Selector.NAVBAR + ' ' + Selector.DROPDOWN_TOGGLE).on("click",
                function(event) {
                    event.preventDefault();
                    setTimeout(function() {
            ...
            var Toasts = /*#__PURE__*/function() {
                ...
                _proto.create = function create() {
                        ...
                        if (this._config.image != null) {
                            var toast_image = $('<img />').addClass('rounded mr-2').attr('src', this._config.image)
                        ...
                        if (this._config.close == true) {
                            var toast_close = $('<button data-dismiss="toast" />').attr('type', 'button')
                                .addClass('ml-2 mb-1 close').attr('aria-label', 'Close')
